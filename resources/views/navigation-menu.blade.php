...
{{--
<!-- component -->
<nav class=" bg-gray-100 w-full flex relative justify-between items-center mx-auto px-8 h-20">
    <!-- logo -->
    ...
    <div class="flex-initial">
        <div class="flex justify-end items-center relative">
            ...
            <div class="flex mr-4 items-center">
                ...
                <ul class="flex gap-[40px] text-m navBarUl">
                    <li><a href="{{route('products')}}"> Productos</a></li>
                    <li><a href="{{route('promociones')}}"> Promociones</a></li>
                    <li><a href="{{route('nosotros')}}"> Nosotros</a></li>
                    <li><a href="{{route('encuentranos')}}"> Encuentranos</a></li>
                </ul>
